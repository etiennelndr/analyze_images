...
class RoadsModel(NNModel):
    ...
    def learn(self):
        ...
        if "test_generator" in self.datas:
            ...
            testLoss, acc_test = self._model.evaluate_generator(self.datas["test_generator"], steps=100, verbose=1)
    ...
    def predictValue(self):
        ...
        # If the result for the second value is moe than 0.85 -> store a 
        # "green" array for this index
        reshaped_img_array[pred >= 0.85, :] = [0, 240, 0]
